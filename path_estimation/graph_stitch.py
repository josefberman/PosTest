...
from path_estimation.graph_utils import (
    astar_path_polyline,
    enu_to_proj_xy,
    merge_polylines,
    nearest_graph_node,
...
from path_estimation.io import align_times_to_true, build_event_points
...
def estimate_graph_stitch(
    ...
    *,
    ...
    if len(merged) < 2:
        from path_estimation.graph_utils import node_xy
